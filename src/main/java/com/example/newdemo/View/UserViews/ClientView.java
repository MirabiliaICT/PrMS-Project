...
public class ClientView extends VerticalLayout implements RouterLayout {
    ...
    @Autowired
    public ClientView(StateService stateService, CityService cityService, UserService userService){
    ...
    private HorizontalLayout getHorizontalLayout() {
        ...
        userTabs.setSelectedTab(client);
    ...
    private HorizontalLayout getToolbar() {
        ...
        var toolbar = new HorizontalLayout(addUser, filterText);
    ...
    private void updateList(){
        if(filterText != null) {
            userGrid.setItems(userService.getAllClientsByFilter(filterText.getValue()));
        }else{
